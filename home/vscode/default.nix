      ...
      vscode = {
        ...
        extensions =
          builtins.attrValues {
            ...
            inherit (vsce.davidanson) vscode-markdownlint;
            ...
            inherit (vsce.formulahendry) code-runner;
            inherit (vsce.github)
              copilot
              copilot-chat
            ...
            inherit (vsce.visualstudioexptteam) vscodeintellicode;
            inherit (vsce.vue) volar;
            inherit (vsce.yoavbls) pretty-ts-errors;
            inherit (vsce.yzhang) markdown-all-in-one;
            inherit (vsce.ziglang) vscode-zig;
          }
        ...
        userSettings = {
          editor = {
            ...
            fontFamily = lib.concatMapStringsSep ", " (s: "'${s}'") (
              flake.config.affineUser.theme.defaultFonts.monospace ++ [ "Material Design Icons" ]
            );
